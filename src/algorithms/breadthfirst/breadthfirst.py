            ...
            if current_depth < depth:
                ...
                for move in possible_moves:
                    ...
                    if parent_game.validate_move(vehicle, new_position):
                        ...
                        # Testing:
                        # print("Current state of B in parent_game: " + str(parent_game.current_state['B']))
                        # print("Current state of B in child_game: " + str(child_game.current_state['B']))
                        child_game_before = child_game.current_state['B']
                        # print("Going to perform move: " + str(move))
                        # print("More accurately: " + vehicle.id + str(new_position))
                        # End Testing
                        child_game.move(vehicle, new_position)
                        print("After moving " + vehicle.id + " to " + str(new_position))
                        print("Current state of B in parent_game: " + str(parent_game.current_state['B']))
                        print("State of B in child game before: " + str(child_game_before))
                        print("Current state of B in child_game: " + str(child_game.current_state['B']))
                        print("")
